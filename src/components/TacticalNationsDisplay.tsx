...
interface Nation {
  ...
  joined: string;
  personnel: string;
  position: { x: number; y: number }; // Position on tactical map
  cimic: CIMICData;
}
...
const nations: Nation[] = [
  { 
    ...
    cimic: {
      ...
      keyCapabilities: 'Host nation support, CIMIC doctrine development, Civil-military coordination training'
    }
  },
  { 
    code: 'DEU', 
    ...
    cimic: {
      ...
      keyCapabilities: 'Engineering support, Infrastructure assessment, Post-conflict reconstruction expertise'
    }
  },
  { 
    code: 'POL', 
    ...
    cimic: {
      ...
      keyCapabilities: 'Cross-border cooperation, Community engagement, Local authority liaison'
    }
  },
  { 
    code: 'DNK', 
    ...
    cimic: {
      ...
      keyCapabilities: 'Stabilization operations, Legal affairs support, Women-Peace-Security programs'
    }
  },
  { 
    code: 'ITA', 
    ...
    cimic: {
      ...
      keyCapabilities: 'Migration crisis response, Cultural property protection, Medical civil support'
    }
  },
  { 
    code: 'CZE', 
    ...
    cimic: {
      ...
      keyCapabilities: 'Disaster response coordination, CBRN civil protection, Emergency management'
    }
  },
  { 
    code: 'ROU', 
    ...
    cimic: {
      ...
      keyCapabilities: 'Rural community support, Agricultural assistance, Civil education programs'
    }
  },
  { 
    code: 'SVN', 
    ...
    cimic: {
      ...
      keyCapabilities: 'Mountain community support, Environmental protection, Youth & sports programs'
    }
  },
];
