...
export function Courses() {
  ...
  // Calculate dates for upcoming courses (example dates)
  ...
  const courses: Course[] = [
    {
      ...
      duration: '2 Weeks',
      targetDate: getUpcomingDate(1),
      description: 'Enables officers and NCOs to conduct CIMIC activities across the full spectrum of military engagement in peacetime, crisis and conflict.',
    ...
    },
    {
      ...
      duration: '2 Weeks',
      targetDate: getUpcomingDate(2),
      description: 'Prepares staff officers to plan and coordinate CIMIC operations at brigade level and above in multinational headquarters.',
      capacity: '24 Students',
      icon: Shield,
      color: '#5a6b3f',
    ...
    },
    {
      ...
      duration: '1 Week',
      targetDate: getUpcomingDate(3),
      description: 'Develops specialized knowledge in specific CIMIC functional areas such as cultural affairs, governance, and infrastructure.',
    ...
    },
    {
      ...
      duration: '1 Week',
      targetDate: getUpcomingDate(4),
      description: 'Designed for senior officers and civilians working at strategic level headquarters requiring advanced CIMIC knowledge.',
    ...
    },
    {
      ...
      duration: '5 Days',
      targetDate: getUpcomingDate(5),
      description: 'Focuses on liaison activities between military forces and civilian actors in complex operational environments.',
      capacity: '20 Students',
      icon: Zap,
      color: '#f7941d',
      classification: 'NCLC'
